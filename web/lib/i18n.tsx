...
const en = {
  ...
  notDistributor: "This login is not a distributor account.",
  wrongPassword: "Wrong phone or password.",
  needSignIn: "Sign in to view this page.",
  signInCta: "Sign in with the phone number you gave the admin.",
  ...
  totalPending: "Priced on invoice",
...
const ar: Strings = {
  ...
  notDistributor: "هذا الحساب ليس حساب موزع.",
  wrongPassword: "الرقم أو كلمة المرور غير صحيحة.",
  needSignIn: "سجّل الدخول لعرض هذه الصفحة.",
  signInCta: "سجّل الدخول برقم الهاتف الذي أعطيته للمدير.",
  ...
  totalPending: "يُسعَّر في الفاتورة",
